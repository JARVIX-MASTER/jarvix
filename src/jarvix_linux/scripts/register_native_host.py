...
def register():
    ...
    host_script = project_root / 'src' / 'jarvix' / 'core' / 'browser_host.py'
    manifest_template = project_root / 'src' / 'jarvix' / 'core' / 'native_manifest.json'
    manifest_output = project_root / 'src' / 'jarvix' / 'core' / 'jarvix_native_host.json'
    ...
    bat_path = project_root / 'jarvix_host.bat'
    ...
    # 3. Registry update
    reg_key = r"Software\Mozilla\NativeMessagingHosts\jarvix.native.host"
    try:
        ...
        print(f"✅ Successfully registered Jarvix Native Host in Registry.")

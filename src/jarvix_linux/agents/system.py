...
import requests
import json
import jarvix_linux.features.activity as activity_monitor
import jarvix_linux.features.clipboard as clipboard_monitor
# import jarvix_linux.features.files.finder as file_finder  # Uses the new smart finder we just created

...
from jarvix_linux.core.brain import process_command
from jarvix_linux.agents.system import execute_command, capture_webcam
import jarvix_linux.core.memory as memory
import jarvix_linux.features.activity as activity_monitor  # Needed to format the output text
import jarvix_linux.features.clipboard as clipboard_monitor  # For clipboard history
# import jarvix_linux.features.files.tracker as file_tracker  # <--- NEW IMPORT: THIS STARTS THE FILE TRACKER AUTOMATICALLY
import jarvix_linux.features.focus_mode as focus_mode # <--- Feature #11: Focus Mode

// Background service worker for Jarvix Activity Monitor
console.log("Jarvix Activity Monitor - Background Service Started");

let nativePort = null;

function connectToNativeHost() {
  nativePort = chrome.runtime.connectNative("jarvix.native.host");
